...
\[f_{z_{final}}(\lambda) = f_{z_{initial}}(\lambda) \frac{\sum_{k=1}^N \(\lambda_{k+1}-\lambda_{k}\)\(f_{z_{initial}}(\lambda_{k+1}+f_{z_{initial}}(\lambda_{k})\)}{\sum_{k=1}^N \(\lambda_{k+1}-\lambda_{k}\)f_{z_{final}}(\lambda_{k+1}+f_{z_{final}}(\lambda_{k})\)}\]
