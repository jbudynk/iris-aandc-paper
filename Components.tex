...
From the user's perspective, he/she supplies the initial and final redshift of the SED and clicks "Create New SED." The returned SED has the same name of the unshifted SED, appended with _redshift. For example, if the final redshift is \textit{z}\(=0.0\) the shifted SED is named "Sed\_0.0."
