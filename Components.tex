...
\[f_{z_{final}}(\lambda) = f_{z_{initial}}(\lambda) \frac{\frac{1}{2}\sum_{k=1}^N \(f_{z_{initial}}(\lambda_{k+1}+f_{z_{initial}}(\lambda_{k})\)}{\frac{1}{2}\sum_{k=1}^N \(f_{z_{final}}(\lambda_{k+1}+f_{z_{final}}(\lambda_{k})\)}\]
